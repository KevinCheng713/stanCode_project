...
This app helps you get rid of annoying passersby and create the perfect landscape image
Users just need to input three or more photos, which taken at the same location, but different times
"""
...
def get_average(pixels):
    ...
    pixel_avg = [red_avg, green_avg, blue_avg]
    return pixel_avg
